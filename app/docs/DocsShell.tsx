...
const TOC_MAP: Record<string, { label: string; href: string }[]> = {
  "/docs": [{ label: "What's inside", href: "#whats-inside" }],
  "/docs/fullstack": [
  ...
  "/docs/web3/solidity": [
    { label: "ERC-20", href: "#erc20" },
    { label: "Reentrancy Guard", href: "#reentrancy" },
    { label: "Bulldex Architecture", href: "#bulldex" },
  ],
  "/docs/web3/ethersjs": [
    { label: "Connect Wallet", href: "#connect" },
    { label: "Read Contract", href: "#read" },
    { label: "Write Transaction", href: "#write" },
  ],
  "/docs/web3/solana": [
    { label: "Wallet Adapter", href: "#wallet" },
    { label: "SPL Tokens", href: "#spl" },
  ...
  "/docs/ai/llm": [
    { label: "Model Selection", href: "#models" },
    { label: "Fallback Chain", href: "#fallback" },
    { label: "Streaming", href: "#streaming" },
  ],
  "/docs/ai/n8n": [
    { label: "Lead Capture", href: "#lead" },
    { label: "Content Pipeline", href: "#content" },
  ],
  "/docs/ai/rag": [
    { label: "Ingestion", href: "#ingest" },
    { label: "Query", href: "#query" },
    { label: "When Not to Use RAG", href: "#no-rag" },
  ],
};
...
const BREADCRUMB_MAP: Record<string, string[]> = {
  ...
  "/docs/web3/ethersjs": ["Web3 & Blockchain", "ethers.js Integration"],
  "/docs/web3/solana": ["Web3 & Blockchain", "Solana Ecosystem"],
