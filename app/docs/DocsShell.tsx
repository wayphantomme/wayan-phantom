...
const NAV_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Image Generation",  href: "/docs/ai-dev/image-gen" },
...
const TOC_MAP: Record<string, { label: string; href: string }[]> = {
  ...
  "/docs/ai-dev/image-gen": [
    { label: "Free Tier",        href: "#free-tier--pricing" },
    { label: "Models",           href: "#available-models" },
    { label: "Daily Estimates",  href: "#daily-quota-estimates-free-tier-10000-neurons" },
    { label: "How It Works",     href: "#how-it-works-in-this-portfolio" },
    { label: "REST API",         href: "#rest-api" },
    { label: "Next.js Route",    href: "#nextjs-route-handler" },
...
const BREADCRUMB_MAP: Record<string, string[]> = {
  ...
  "/docs/ai-dev/image-gen":    ["AI Developer", "Image Generation"],
